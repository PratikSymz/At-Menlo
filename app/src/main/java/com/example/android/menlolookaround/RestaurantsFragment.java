...
public class RestaurantsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        places.add(new Place(getString(R.string.R1_name_Evvia), getString(R.string.R1_address_Evvia),
        ...
        places.add(new Place(getString(R.string.R2_name_Orens), getString(R.string.R2_address_Orens),
        ...
        places.add(new Place(getString(R.string.R3_name_Refuge), getString(R.string.R3_address_Refuge),
        ...
        places.add(new Place(getString(R.string.R4_name_Tamarine), getString(R.string.R4_address_Tamarine),
        ...
        places.add(new Place(getString(R.string.R5_name_MenloGrill), getString(R.string.R5_address_MenloGrill),
        ...
        places.add(new Place(getString(R.string.R6_name_Sundance), getString(R.string.R6_address_Sundance),
        ...
        places.add(new Place(getString(R.string.R7_name_Madera), getString(R.string.R7_address_Madera),
        ...
        places.add(new Place(getString(R.string.R8_name_Flea), getString(R.string.R8_address_Flea),
        ...
        places.add(new Place(getString(R.string.R9_name_Stacks), getString(R.string.R9_address_Stacks),
        ...
        places.add(new Place(getString(R.string.R10_name_SqueezeIn), getString(R.string.R10_address_SqueezeIn),
