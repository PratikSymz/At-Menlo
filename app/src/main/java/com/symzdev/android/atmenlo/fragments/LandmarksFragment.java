...
public class LandmarksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Create the ArrayList for the landmarks
        ArrayList<Place> landmarks = new ArrayList<>();

        // Add the landmarks to the ArrayList
        landmarks.add(new Place(getString(R.string.L1_name_Fremont), getString(R.string.L1_address_Fremont),
        ...
        landmarks.add(new Place(getString(R.string.L2_name_PaloAltoTW), getString(R.string.L2_address_PaloAltoTW),
        ...
        landmarks.add(new Place(getString(R.string.L3_name_Hanna), getString(R.string.L3_address_Hanna),
        ...
        landmarks.add(new Place(getString(R.string.L4_name_AngelOG), getString(R.string.L4_address_AngelOG),
        ...
        landmarks.add(new Place(getString(R.string.L5_name_StoneRiverAG), getString(R.string.L5_address_StoneRiverAG),
        ...
        landmarks.add(new Place(getString(R.string.L6_name_Rengstorff), getString(R.string.L6_address_Rengstorff),
        ...
        landmarks.add(new Place(getString(R.string.L7_name_HP), getString(R.string.L7_address_HP),
                getString(R.string.L7_desc_HP), R.drawable.l7_hp_final, getString(R.string.L7_site_HP),
                getString(R.string.L7_location_HP)));
        landmarks.add(new Place(getString(R.string.L8_name_HooverT), getString(R.string.L8_address_HooverT),
        ...
        landmarks.add(new Place(getString(R.string.L9_name_CourthouseSq), getString(R.string.L9_address_CourthouseSq),
        ...
        landmarks.add(new Place(getString(R.string.L10_name_Lathrop), getString(R.string.L10_address_Lathrop),
        ...
        // Create a new adapter that takes the list of landmarks as input
        PlaceAdapter adapter = new PlaceAdapter(getActivity(), landmarks);
